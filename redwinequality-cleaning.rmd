...
```
Parece apreciarse que los vinos con mayor calidad presentan una gran cantidad relativa de alcohol y de acido cítrico de manera simultánea.
...
```
El gráfico de dispersión muestra que los vinos de mayor calidad suelen presentar una mezcla de alcohol en cantidad relativa grande y una cantidad relativa pequeña de dioxido de azufre.
...
```
Observamos claramente como los vinos de calidad tienen una cantidad relativa pequeña de dioxido de azufre, independientemente de la cantidad de acido cítrico.
...
Tras el análisis inicial de nuestras variables independientes, ya podíamos ver que varias de nuestras variables eran combinación lineal de otras, y por tanto las hemos excluido del análisis.
