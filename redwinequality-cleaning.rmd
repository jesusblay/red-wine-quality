...
```
A pesar de que analizaremos la correlación más adelante, podemos apoyarnos en un gráfico de correlación para corroborar las observaciones hechas anteriormente con los boxplots. 
...
Vamos a explorar como varían de manera conjunta algunas de las parejas de variables en las que ya hemos inferido una probable relación, distinguiendo la calidad del vino.
